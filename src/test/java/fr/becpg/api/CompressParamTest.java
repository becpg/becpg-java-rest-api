...
class CompressParamTest {
	...
	private static final String PARAM1 = """
			bcpg:code,bcpg:erpCode,cm:name,cm:title,bcpg:eanCode,bcpg:legalName,cm:description,bcpg:entityTplRef\
	...
	private static final String PARAM2 = "(@cm\\:created:[%s TO MAX] OR @cm\\:modified:[%s TO MAX]) AND ( TYPE:\"bcpg:product\" OR TYPE:\"bcpg:client\" OR TYPE:\"bcpg:supplier\" ) AND =bcpg\\:code:\"PF1000015754\"";
